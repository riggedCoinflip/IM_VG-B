# Camunda BPM Process Application *IMSarter*
A Process Application for [Camunda BPM](http://docs.camunda.org) to get started
in "IM-Projekt 2020/2021"
...
## How to use it?
After building and deployment, see below,

you start from **Camunda Web App *Tasklist* ** the processs **startandsend**,
depending on value of Age do a user task in process **receiveandreply** and
